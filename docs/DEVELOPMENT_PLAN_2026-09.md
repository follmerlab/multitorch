...
9. The five Fe v0 fits were never re-run with the V2 dispatcher, and must not be re-run until S1 is fixed. **(S1 fixed 2026-09-13: re-run is unblocked.)**
...
| S6 API semantics, S7 parity metric, S8 FD autograd test | open — next |
| Half-integer J on the projected emitters (Fe(III), Co(II), Cu(II), …) | open → WP-B double group |
| Fe v0 fits re-run | unblocked (S1a landed) |
